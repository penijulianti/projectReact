...
export default function HeaderAdmin() {
  ...
  return (
    <header className="sticky top-0 w-full h-28 bg-black bg-opacity-75 text-custom-color z-50">
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <nav className="hidden md:flex flex-grow justify-end space-x-4">
          <Link to="/admin" className="text-custom-color">
            List Akun
          </Link>
          <Link to="/all" className="text-custom-color">
            List Video
          </Link>
          <Link to="/videoAdmin" className="text-custom-color">
            My Videos
          </Link>
        </nav>
      </div>
